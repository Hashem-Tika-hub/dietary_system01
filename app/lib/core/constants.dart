...
class AppConfig {
  ...
  static String get baseUrl {
    if (kIsWeb) return 'http://localhost:8000';           // Flutter Web (Chrome)
    if (Platform.isAndroid) return 'http://10.0.2.2:8000'; // محاكي أندرويد
    return 'http://localhost:8000';                        // محاكي iOS / سطح المكتب
  }
